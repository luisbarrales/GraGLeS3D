...
while true; do
	...
	if [ -f  $CURRENT_PATTERN ]; then			
		GNUPLOT_STRING="gnuplot -e \"set palette rgbformulae 33,13,10; set cbrange[0:0.6]; set cbtics 0.1; set term png giant size 1024,768; set output '$CURRENT_FILENAME'; set yrange [:] reverse; plot"
